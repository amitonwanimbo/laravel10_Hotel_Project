...
<head>
    ...
    <title>  {{ Auth::user()->role }}</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="{{asset('Admilte/dist/css/adminlte.css')}}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
            <!-- Navbar -->
                 @include('staf.partials.navbar')
            <!-- Navbar -->
            <!--begin::Sidebar Menu-->
                @include('staf.partials.sidebar')
            <!--end::Sidebar Menu-->
...
<script>
    function confirmDelete() {
        return confirm('Apakah Anda yakin mau hapus user ini?');
    }
</script>
